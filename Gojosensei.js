...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
    try {
        ...
        const groupالمطور = m.isGroup ? groupMetadata.owner : ''
...
const reply = (teks) => {
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  //antilink\\
        ...
        reply(`「 ANTI LINK 」\n\nأنت أرسلت رابطا سيتم طردك !`)
        if (!isBotAdmins) return reply(`I أنا لست مشرف لأطرد😒`)
        ...
        if (isCreator) return reply(`Group Is Installed With Anti-Link But I Won't Kick You 😉, Because You Are My المطور Hahahahah🤣😘, You Think I Will Betray You Huh🐦`)
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await GojoMdNx.send5ButImg(from, `` + '' + teksehmazeh, `© ${footer}`, GojoMdNx, [{"urlButton": {"displayText": "إنستغرامي📍","url": `${myweb}`}}])
  }
  break
        case 'userlimit': 
{      
	...
	break
	    case 'setname': case 'setgcname': case 'setsubject': {
          ...
          case 'setdesc': case 'setdesk': {
                ...
                if (!isAdmins) replay(`${mess.admin}`)
                if (!text) replay(`Where Is The Text?`)
                await GojoMdNx.groupUpdateDeإنستغراميion(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
            }
            break
          case 'setbotpp': {
                if (!isCreator) return replay(`${mess.owner}`)
...
let teks = `╚»˙·٠•●♥ Tag All ♥●•٠·˙«╝ 
 ...
 ➲ *Message : ${q ? q : 'no message'}*\n\n`
	    ...
	    break
            ...
            if (!text) return replay(`Enter Reason For Vote, Example: *${prefix + command} Handsome المطور*`)
...
🐦 Deإنستغراميion : ${anu.deإنستغراميion}
🐦 Url : ${anu.url}`,
                    footer: GojoMdNx.user.name,
                    buttons: buttons,
                    headerType: 4
...
case 'webtonsearch': case 'webtoon':
		...
		if (anu.type == 'video') {
		    let buttons = [
                        {buttonId: `ytmp3 ${anu.media[0]} 128kbps`, buttonText: {displayText: '🎵موسيقى🎵'}, type: 1},
...
View List Of Messages With ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'mulai': case 'start': {
                ...
                if (room) {
                    let buttons = [
                        { buttonId: 'التالي', buttonText: { displayText: '⏩Skip⏩' }, type: 1 },
                        { buttonId: 'keluar', buttonText: { displayText: '🛑Stop🛑' }, type: 1 }
                    ]
...
Report Message: ${text}` })
reply(`Successfully Reported To The المطور\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    }
                    break
                     case 'alive': case 'bot':{
                           	timestampe = speed();
...
│✙ مدت التشغيل : ${runtime(process.uptime())}
│✙ إسم البوت : ${global.botname}
│✙ إسم المطور : ${global.ownername}
│✙ رقم المطور : ${global.owner}
│✙ 𝗛𝗼𝘀𝘁 𝗡𝗮𝗺𝗲 : ${os.hostname()}
│✙ 𝗣𝗹𝗮𝘁𝗳𝗼𝗿𝗺 : ${os.platform()}
│✙ جميع المستخدمون : ${Object.keys(global.db.data.users).length}
└┬──────────────┈ ⳹
   │✑  إختر من هنا
   └───────────────┈ ⳹`,
                            hydratedButtons: [{
...
│ 「 BOT INFO 」
│✙ السرعة : ${latensie.toFixed(4)} miliseconds
│✙ مدت الشغيل : ${runtime(process.uptime())}
│✙ إسم البوت : ${global.botname}
│✙ إسم المطور : ${global.ownername}
│✙ رقم المطور : ${global.owner}
│✙ 𝗛𝗼𝘀𝘁 𝗡𝗮𝗺𝗲 : ${os.hostname()}
│✙ 𝗣𝗹𝗮𝘁𝗳𝗼𝗿𝗺 : ${os.platform()}
│✙ المستخدمين : ${Object.keys(global.db.data.users).length}
 instagrame.com/mohammed_xf16
└┬──────────────┈ ⳹
   │✑  إختر من هنا
   └───────────────┈ ⳹`,
                            hydratedButtons: [{
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Hi ${pushname}`,
                    deإنستغراميion: `Please Choose The Menu\n\n`,
                    buttonText: "Menu",
                    ...
                    sections: [{
								...
								"rows": [
									{
										"title": "Main Menu",
										"deإنستغراميion": "Displays The List Of Main Features",
							...
							},
							{
								...
								"rows": [
									{
										"title": "All Menu",
										"deإنستغراميion": "Displays The List Of All The Features!",
										"rowId": `${prefix}allmenu`
									},
									{
										"title": "المطور Menu",
										"deإنستغراميion": "Displays The List Of المطور Features",
									...
									{
										"title": "Rpg Menu",
										"deإنستغراميion": "Displays The List Of Rpg Features",
										"rowId": `${prefix}rpgmenu`
									},
									{
										"title": "Download Menu",
										"deإنستغراميion": "Displays The List Of Download Features",
										"rowId": `${prefix}downloadmenu`
									},
									{
										"title": "Search Menu",
										"deإنستغراميion": "Displays The List Of Searching Features",
										"rowId": `${prefix}searchmenu`
									},
									{
											"title": "Random Menu",
										"deإنستغراميion": "Displays The List Of Random Features",
										"rowId": `${prefix}randommenu`
										},
										{
											"title": "Random Anime Menu",
										"deإنستغراميion": "Displays The List Of Random Anime Features",
										"rowId": `${prefix}randomanimemenu`
										},
										{
											"title": "Fun Menu",
										"deإنستغراميion": "Displays The List Of Fun Features",
										"rowId": `${prefix}funmenu`
										},
										{
											"title": "Convert Menu",
										"deإنستغراميion": "Displays The List Of Convert Features",
										"rowId": `${prefix}convertmenu`
										},
										{
											"title": "Database Menu",
										"deإنستغراميion": "Displays The List Of Database Features",
										"rowId": `${prefix}databasemenu`
										},
										{
											"title": "Voice Changer Menu",
										"deإنستغراميion": "Displays The List Of Voice Changing Features",
										"rowId": `${prefix}voicechangermenu`
										},
										{
											"title": "TXT-to-IMG Menu",
										"deإنستغراميion": "Displays The List Of Textpro Features",
										"rowId": `${prefix}textpromenu`
										},
										{
											"title": "Islamic Menu",
										"deإنستغراميion": "Displays The List Of Islamic Features",
										"rowId": `${prefix}islamicmenu`
										},
										{
											"title": "Horoscope Menu",
										"deإنستغراميion": "Displays The List Of Horoscope Features",
								...
								"rows": [
									{
										...
										"deإنستغراميion": "Displays The List Of Anonymous Chat Features",
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To",
										"deإنستغراميion": "Displays The List Of Credit Of The Bot !!",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "إنستغرامي 📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرامي🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤المطور👤","id": 'owner'}}] )
break
...
case 'ownermenu':
var unicorn = await getBuffer(picak+'المطور Menu')
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
┏━「 ${botname} 」━━⭓ 
┃╔═✪「 المطور فقط 」	        
┃╠${prefix}grouplink
...
┃╠${prefix}shio (indo)
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "إنستغرامي📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرام🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤المطور👤","id": 'owner'}}] )
break
case 'thanksto': case 'tqto': case 'tqtt':
var unicorn = await getBuffer(picak+'Developer')
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
Thanks to Me ( vanitas)
vanitas (For helping me to deploy qr in replit and answered my every doubts regard this project)
vanitas ( 45% Credits goes to him ,in this إنستغرامي)
And Again Me (King vanitas 🎉) 🐦 Who Helped Assemble This Sexy إنستغرامي !!!`,unicorn, [{"urlButton": {"displayText": "إنستغرامي📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرامي🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤المطور👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
		...
		if (m.chat.endsWith('@s.whatsapp.net') && isCmd) {
                    ...
                    if (room) {
                        if (/^.*(التالي|leave|start)/.test(m.text)) return
                        if (['.التالي', '.leave', '.stop', '.start', 'Cari Partner', 'Keluar', 'Lanjut', 'Stop'].includes(m.text)) return
