...
│✙ 𝗧𝗼𝘁𝗮𝗹 𝗨𝘀𝗲𝗿 : ${Object.keys(global.db.data.users).length}
└┬──────────────┈ ⳹
   │✑  instagram.com/mohammed_xf16
   └───────────────┈ ⳹`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'إنستغرام المطور',
                                    url: `${myweb}`
                                }
                            }, {
                            	urlButton: {
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "إنستغرامي",
										"description": "تابعني على إنستغرام !!",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "إنستغرام 📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرام🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜ig🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤المطور👤","id": 'owner'}}] )
break
...
┃╠${prefix}delvote
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "إنستغرام📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرام🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜vanitas🍜","id": 'owner'}},{"quickReplyButton": {"displayText": "👤المطور👤","id": 'owner'}}] )
break
...
┃╠${prefix}sell [option]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "إنستغرام📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرام🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜vanitas🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
...
┃╠ ${prefix}suitpvp [tag]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "إنستغرام📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرام🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤المطور👤","id": 'owner'}}] )
break
...
┃╠${prefix}delvote
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "المطور📍","url": `${myweb}`}},{"urlButton": {"displayText": "إنستغرام🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜vanitas🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤المطور👤","id": 'owner'}}] )
break
case 'downloadmenu':
